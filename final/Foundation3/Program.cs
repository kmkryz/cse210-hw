...
class Program
{
    static void Main(string[] args)
    {
        ...
        Lecture lectureEvent = new Lecture("Runway Tech Talk", "Exciting tech discussion featuring the\nnewest updates for TBoT Max!", "01-15-2023", "3:00 PM", address1, "Thomas Rankin", 50);

        Address address2 = new Address("456 Park Ave", "Cocoaville", "FL", "67890");
        Reception receptionEvent = new Reception("Luspy Networking Mixer", "Casual networking event for\nour newest employees", "02-23-2023", "5:30 PM", address2, "rsvp@example.com");
